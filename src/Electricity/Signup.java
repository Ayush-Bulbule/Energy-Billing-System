...
import java.io.IOException;
 ...
 public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/signupimg.png"));
        ...
        if(ae.getSource()==b1){
            ...
            try{
                ...
                if(user.equals("admin")){
                    ...
                    str = "update login set username = '"+username+"', name = '"+name+"', pass = '"+password+"', usr = '"+user+"' where meter_no = '"+t4.getText()+"'";
                }
                
                int res =  c.s.executeUpdate(str);

...
//        setResizable(false);
        ...
        ImageIcon ic = new ImageIcon(new ImageIcon(ClassLoader.getSystemResource("icon/energybackground.png")).getImage().getScaledInstance(dim.width,dim.height-100,  Image.SCALE_DEFAULT));
//        Image i3 = ic.getImage().getScaledInstance(dim.width,dim.height,Image.SCALE_DEFAULT);
//        ImageIcon icc3 = new ImageIcon(i3);
        ...
        master.setFont(new Font("Calibri",Font.BOLD,18));
        ...
        /* ---- Customer Details ---- */
        m1.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        /* ---- Meter Details ---- */
        m2.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        m2.setBackground(Color.WHITE);
         ...
         /* ---- Deposit Details  ----- */
        m3.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        m4.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        /* ---- Pay Bill ---- */
        info1.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        /* ---- Last Bill ----*/
        info2.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        user.setFont(new Font("Calibri",Font.BOLD,18));
        ...
        /* ---- Pay Bill ---- */
        u1.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        /* ---- Last Bill ----*/
        u3.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        utility.setFont(new Font("Calibri",Font.BOLD,18));
        ...
        /* ---- Calender ---- */
        ut1.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        /* ---- Calculator ---- */
        ut2.setFont(new Font("Calibri",Font.PLAIN,18));
        ...
        /* ---- Web Browser ---- */
        ut3.setFont(new Font("Calibri",Font.PLAIN,18));
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/ic_chrome.png"));
